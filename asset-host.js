(function (global) {
  ...
  const repositoryByGame = {
    ...
    BadPiggies: 'gamefiles03', MuddyHeights: 'gamefiles03', 2048: 'gamefiles03',
    TheVisitor: 'gamefiles03', SnailBob: 'gamefiles03', SnailBob2: 'gamefiles03', SnailBob3: 'gamefiles03',
